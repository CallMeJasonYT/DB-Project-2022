...
public class Menu extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        listMenu1.addItem(new Model_Menu("trips", "Check Trips", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("offers", "Check Offers", Model_Menu.MenuType.MENU));
