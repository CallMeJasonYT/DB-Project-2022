...
public class CustomButton extends JButton {
    ...
    public enum ButtonStyle {
        PRIMARY(new Color(106, 228, 92), new Color(238, 238, 238), new Color(2, 111, 82), new Color(4, 205, 151)),
        SECONDARY(new Color(255, 190, 75), new Color(238, 238, 238), new Color(81, 92, 108), new Color(230, 239, 255)),
        DELETE(new Color(230, 158, 255), new Color(238, 238, 238), new Color(81, 92, 108), new Color(230, 239, 255)),
        DESTRUCTIVE(new Color(255, 44, 44), new Color(238, 238, 238), new Color(198, 86, 0), new Color(255, 161, 90));
